...
$obj = Compare-Object (($inputObj | ConvertTo-Json -Depth 4) -split '\r?\n') (($SPobj | ConvertTo-Json -Depth 4) -split '\r?\n')


<#
Write-Host "_______________________input______________________"
(($inputObj | ConvertTo-Json -Depth 4) -split '\r?\n')
Write-Host "______________________current_______________________"
(($SPobj | ConvertTo-Json -Depth 4) -split '\r?\n')
